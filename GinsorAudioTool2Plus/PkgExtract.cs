...
namespace GinsorAudioTool2Plus
{
  internal class PkgExtract
  {
    ...
    public void ExtractAll(string outputDir)
    {
      ...
      Parallel.ForEach<PkgEntry>(this._pkgStream.PkgEntryList, new Action<PkgEntry>(extractAllHelper.ExtractAll0));
    }
    ...
    {
      byte[] result;
      using (AuthenticatedAesCng authenticatedAesCng = new AuthenticatedAesCng())
      {
